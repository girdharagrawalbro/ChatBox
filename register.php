...
if (isset($_SESSION['data']) && isset($_SESSION['username'])) {
   ...
   echo "<script>window.location.href = 'chat_list.php';</script>";
...
<body><div class="form-container">
      ...
      <p class="sign-up-label">
        Already Registered? <span class="sign-up-link">
        <a href="login.php">Log in</span></a>    
      </p>
...
$email_check_query = "SELECT * FROM user WHERE username='$username' LIMIT 1";
